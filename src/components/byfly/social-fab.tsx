...
const INSTAGRAM_URL = CONFIG.instagram
const WHATSAPP_URL  = `https://wa.me/${CONFIG.whatsapp}`
const TIKTOK_URL    = CONFIG.tiktok

export function SocialFab() {
  const [open, setOpen] = useState(false)

  return (
    <div className="fixed bottom-6 right-5 z-[400] flex flex-col items-center gap-3">
      {/* Sub-buttons */}
      <AnimatePresence>
        {open && (
          <>
            ...
            <motion.a
              ...
              className="w-12 h-12 rounded-full flex items-center justify-center shadow-lg bg-[#010101]"
            >
            ...
            <motion.a
              ...
              className="w-12 h-12 rounded-full flex items-center justify-center shadow-lg bg-[#25D366]"
            >
