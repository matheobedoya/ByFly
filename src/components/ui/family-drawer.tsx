...
function FamilyDrawerTrigger({
  ...
  if (asChild) {
    return (
      <Drawer.Trigger render={<Slot />}>{children}</Drawer.Trigger>
    )
  }

  return (
    <Drawer.Trigger render={<button className={clsx(
                ...
                className
              )} type="button" />}>{children}</Drawer.Trigger>
  )
}
  ...
  if (asChild) {
    return (
      <Drawer.Content className={clsx(
                  ...
                  className
                )} render={<Slot />}>{content}</Drawer.Content>
    )
  }
...
function FamilyDrawerClose({
  ...
  if (asChild) {
    return (
      <Drawer.Close render={<Slot />}>{defaultClose}</Drawer.Close>
    )
  }
